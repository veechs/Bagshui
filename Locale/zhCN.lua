Bagshui:LoadComponent(function()
    ...
    ["ItemPropFriendly_name"] = "!!名称!!",
    ["ItemPropFriendly_periodicTable"] = "周期表",
    ["ItemPropFriendly_quality"] = "!!品质!!",
    ...
    ["EditMode_Prompt_DeleteGroup"] = "删除选定的组？!!警告 不可撤销!!",
    ...
    -- 设置菜单（设置本身的本地化在 `settingsStrings` 中配置）。
    ...
    ["Menu_Category_Remove_TooltipText"] = "从当前组中移除此类别。!!信息不删除!!",
    ...
    ["Menu_Group_Delete_TooltipText"] = "完全删除此组并取消分配任何类别。!!警告 不可撤销!!",
    ...
    ["Menu_Group_Remove_Category_TooltipText"] = "移除此组中当前分配的类别。!!信息不删除!!",
    ...
    ["ObjectManager_DeletePrompt"] = "删除以下 %s？%s%s!!警告 不可撤销!!",  -- "删除类别 '<类别名称>'？"
    ["ObjectManager_DeleteForPrompt"] = "删除 '%s' 的 %s？%s!!警告 不可撤销!!",  -- "删除 '<角色名称>' 的角色数据？"
    ...
    ["ProfileManager_ReplacePrompt"] = "将 '%s' 配置文件的 %s 配置替换为 '%s' 的配置？!!警告 不可撤销!!",  -- "将 '目标' 配置文件的设计配置替换为 '源' 的配置？"
    ...
    ["RuleFunction_Name_GenericDescription"] = "检查物品名称是否包含指定字符串。!!支持Lua字符串模式匹配!!",
    ["RuleFunction_Name_Example1"] = 'Name("string")',
    ["RuleFunction_Name_ExampleDescription1"] = "检查物品名称是否包含指定字符串。!!支持Lua字符串模式匹配!!",
    ["RuleFunction_Name_ExampleExtra1"] = 'Name("string1", "string2", "stringN")',
    ["RuleFunction_Name_ExampleDescriptionExtra1"] = "检查物品名称是否包含任何指定字符串。!!支持Lua字符串模式匹配!!",
    ...
    ["RuleFunction_PeriodicTable_GenericDescription"] = "检查物品是否属于规则表集合。!!规则表参数区分大小写!!",
    ["RuleFunction_PeriodicTable_ExampleDescription"] = "检查物品是否属于 '%s' 规则表集合。!!规则表参数区分大小写!!",
    ["RuleFunction_PeriodicTable_ExampleExtra1"] = 'PeriodicTable("set1", "set2", "setN")',
    ["RuleFunction_PeriodicTable_ExampleDescriptionExtra1"] = "检查物品是否属于任何指定的规则表集合。!!规则表参数区分大小写!!",
    ...
    ["RuleFunction_Tooltip_GenericDescription"] = "检查提示是否包含指定字符串。!!支持Lua字符串模式匹配!!",
    ["RuleFunction_Tooltip_Example1"] = 'Tooltip("string")',
    ["RuleFunction_Tooltip_ExampleDescription1"] = "检查物品提示是否包含指定字符串。!!支持Lua字符串模式匹配!!",
    ["RuleFunction_Tooltip_ExampleExtra1"] = 'Tooltip("string1", "string2", "stringN")',
    ["RuleFunction_Tooltip_ExampleDescriptionExtra1"] = "检查提示是否包含任何指定字符串。!!支持Lua字符串模式匹配!!",
