...
---@param bagNumParam number? When given and there's no hookSettingTranslations match, return hookBagX, where X is bagNumParam.
...
function Inventory:GetHookSettingName(hookFunctionName, bagNumParam)
	...
	if retVal == nil and bagNumParam and self.myContainerIds[bagNumParam] then
